...
.Ltext0:
	...
	.section	.text._Z8evt_initv,"ax",@progbits
	.align	1
	.globl	_Z8evt_initv
	.type	_Z8evt_initv, @function
_Z8evt_initv:
.LFB3:
.LM1:
	.cfi_startproc
.LM2:
	...
	.cfi_endproc
.LFE3:
	.size	_Z8evt_initv, .-_Z8evt_initv
	.section	.text._Z8evt_pushPKcz,"ax",@progbits
	.align	1
	.globl	_Z8evt_pushPKcz
	.type	_Z8evt_pushPKcz, @function
_Z8evt_pushPKcz:
.LVL0:
.LFB4:
.LM3:
...
.LM5:
	...
	.cfi_offset 8, -40
.LM6:
	lui	s0,%hi(event_queue)
.LM7:
	sw	a5,180(sp)
.LM8:
	lw	a5,%lo(event_queue)(s0)
.LM9:
	sw	ra,156(sp)
	.cfi_offset 1, -36
.LM10:
...
.LM33:
	...
	.cfi_endproc
.LFE4:
	.size	_Z8evt_pushPKcz, .-_Z8evt_pushPKcz
	.text
.Letext0:
...
.LASF458:
	.string	"__FILENAME_WO_SUFFIX__ \"rtos_eventspp\""
.LASF667:
...
.LASF464:
	.string	"__COMPONENT_FILE_NAME_DEQUOTED__ suas_app_freertos_watchdogrtos_eventspp"
.LASF948:
...
.LASF1219:
	.string	"__ptr_t void *"
.LASF463:
	.string	"__COMPONENT_FILE_NAMED__ suas_app_freertos_watchdog.rtos_eventspp"
.LASF1541:
	.string	"copy"
.LASF1081:
...
.LASF457:
	.string	"__FILENAME__ \"rtos_events.cpp\""
.LASF1229:
	.string	"__END_DECLS }"
.LASF835:
...
.LASF462:
	.string	"__COMPONENT_FILE_NAME__ \"suas_app_freertos_watchdogrtos_eventspp\""
.LASF1292:
...
.LASF459:
	.string	"__FILENAME_WO_SUFFIX_DEQUOTED__ rtos_eventspp"
.LASF684:
...
.LASF0:
	.string	"/home/shivani/bl602_iot_sdk/customer_app/suas_app_freertos_watchdog/suas_app_freertos_watchdog/rtos_events.cpp"
.LASF1562:
	.string	"queue.h"
.LASF1558:
	.string	"rtos_events.cpp"
.LASF1563:
	.string	"stdarg.h"
.LASF1566:
	.string	"stdio.h"
