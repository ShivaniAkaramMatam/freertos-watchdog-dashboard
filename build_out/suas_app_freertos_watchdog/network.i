# 0 "/home/shivani/bl602_iot_sdk/customer_app/suas_app_freertos_watchdog/suas_app_freertos_watchdog/network.c"
# 1 "/home/shivani/bl602_iot_sdk/customer_app/suas_app_freertos_watchdog/build_out/suas_app_freertos_watchdog//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/shivani/bl602_iot_sdk/customer_app/suas_app_freertos_watchdog/suas_app_freertos_watchdog/network.c"
# 1 "/home/shivani/bl602_iot_sdk/customer_app/suas_app_freertos_watchdog/suas_app_freertos_watchdog/network.h" 1



# 1 "/home/shivani/bl602_iot_sdk/toolchain/compiler/lib/gcc/riscv32-unknown-elf/15.1.0/include/stdbool.h" 1 3 4
# 5 "/home/shivani/bl602_iot_sdk/customer_app/suas_app_freertos_watchdog/suas_app_freertos_watchdog/network.h" 2
...
# 6 "/home/shivani/bl602_iot_sdk/customer_app/suas_app_freertos_watchdog/suas_app_freertos_watchdog/network.h" 2
...
# 12 "/home/shivani/bl602_iot_sdk/customer_app/suas_app_freertos_watchdog/suas_app_freertos_watchdog/network.h"
void network_init(const char* ssid, const char* password, const char* server_ip, uint16_t server_port);
...
# 2 "/home/shivani/bl602_iot_sdk/customer_app/suas_app_freertos_watchdog/suas_app_freertos_watchdog/network.c" 2
# 1 "/home/shivani/bl602_iot_sdk/customer_app/suas_app_freertos_watchdog/suas_app_freertos_watchdog/safe_print.h" 1
...
# 3 "/home/shivani/bl602_iot_sdk/customer_app/suas_app_freertos_watchdog/suas_app_freertos_watchdog/network.c" 2
...
# 4 "/home/shivani/bl602_iot_sdk/customer_app/suas_app_freertos_watchdog/suas_app_freertos_watchdog/network.c" 2
...
# 5 "/home/shivani/bl602_iot_sdk/customer_app/suas_app_freertos_watchdog/suas_app_freertos_watchdog/network.c" 2
...
# 6 "/home/shivani/bl602_iot_sdk/customer_app/suas_app_freertos_watchdog/suas_app_freertos_watchdog/network.c" 2
...
# 7 "/home/shivani/bl602_iot_sdk/customer_app/suas_app_freertos_watchdog/suas_app_freertos_watchdog/network.c" 2


# 8 "/home/shivani/bl602_iot_sdk/customer_app/suas_app_freertos_watchdog/suas_app_freertos_watchdog/network.c"
static struct bflb_tcp_client_s tcp_client;
static bool tcp_connected = false;
static char server_ip_str[32];
static uint16_t server_port;

void network_init(const char* ssid, const char* password, const char* server_ip, uint16_t port)
{

    strncpy(server_ip_str, server_ip, sizeof(server_ip_str));
    ...
    bflb_wifi_init();
    bflb_wifi_sta_init();
    bflb_wifi_sta_connect(ssid, password, strlen(ssid), strlen(password));


    safe_printf("Connecting to Wi-Fi...\n");
    while (!bflb_wifi_sta_is_connected()) {
        vTaskDelay(( ( TickType_t ) ( ( ( TickType_t ) ( 500 ) * ( TickType_t ) ( ( TickType_t ) 1000 ) ) / ( TickType_t ) 1000 ) ));
    }
    safe_printf("Wi-Fi connected!\n");


    tcp_client.ip_type = BFLB_TCP_CLIENT_IP_TYPE_V4;
    tcp_client.port = server_port;
    strcpy(tcp_client.host, server_ip_str);

    if (bflb_tcp_client_init(&tcp_client) == 0) {
        if (bflb_tcp_client_connect(&tcp_client) == 0) {
            tcp_connected = true;
            safe_printf("TCP connected to %s:%d\n", server_ip_str, server_port);
        } else {
            safe_printf("TCP connection failed\n");
        }
    } else {
        safe_printf("TCP client init failed\n");
    }
}

bool network_wifi_connected(void)
{
    return bflb_wifi_sta_is_connected();
}
...
void network_send(const char* msg)
{
    ...
    int len = strlen(msg);
    if (len > 0) {
        bflb_tcp_client_write(&tcp_client, (uint8_t*)msg, len);
    }
}
