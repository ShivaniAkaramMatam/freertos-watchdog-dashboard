# 0 "/home/shivani/bl602_iot_sdk/components/freertos/portable/GCC/RISC-V/port.c"
# 1 "/home/shivani/bl602_iot_sdk/customer_app/suas_app_freertos_watchdog/build_out/freertos//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/shivani/bl602_iot_sdk/components/freertos/portable/GCC/RISC-V/port.c"
# 33 "/home/shivani/bl602_iot_sdk/components/freertos/portable/GCC/RISC-V/port.c"
...
# 34 "/home/shivani/bl602_iot_sdk/components/freertos/portable/GCC/RISC-V/port.c" 2
...
# 35 "/home/shivani/bl602_iot_sdk/components/freertos/portable/GCC/RISC-V/port.c" 2
# 1 "/home/shivani/bl602_iot_sdk/components/freertos/portable/GCC/RISC-V/portmacro.h" 1
# 36 "/home/shivani/bl602_iot_sdk/components/freertos/portable/GCC/RISC-V/port.c" 2
...
# 39 "/home/shivani/bl602_iot_sdk/components/freertos/portable/GCC/RISC-V/port.c" 2
# 77 "/home/shivani/bl602_iot_sdk/components/freertos/portable/GCC/RISC-V/port.c"
...
uint32_t const ullMachineTimerCompareRegisterBase = ( ( (0x02000000UL) ) + 0x4000UL );
volatile uint64_t * pullMachineTimerCompareRegister = 
# 95 "/home/shivani/bl602_iot_sdk/components/freertos/portable/GCC/RISC-V/port.c" 3 4
                                                     ((void *)0)
# 95 "/home/shivani/bl602_iot_sdk/components/freertos/portable/GCC/RISC-V/port.c"
                                                         ;
BaseType_t TrapNetCounter = 0;
const BaseType_t *pTrapNetCounter = &TrapNetCounter;
# 123 "/home/shivani/bl602_iot_sdk/components/freertos/portable/GCC/RISC-V/port.c"
 void vPortSetupTimerInterrupt( void )
 {
 uint32_t ulCurrentTimeHigh, ulCurrentTimeLow;
 volatile uint32_t * const pulTimeHigh = ( volatile uint32_t * const ) ( ( ( ( (0x02000000UL) ) + 0xBFF8UL ) ) + 4UL );
 volatile uint32_t * const pulTimeLow = ( volatile uint32_t * const ) ( ( ( (0x02000000UL) ) + 0xBFF8UL ) );
...
extern void xPortStartFirstTask( void );
...

 {
  ...
  if( ( ( xISRStackTop & ( 0x000f ) ) == 0 ) == 0 ) vAssertCalled();
...
# 197 "/home/shivani/bl602_iot_sdk/components/freertos/portable/GCC/RISC-V/port.c"
