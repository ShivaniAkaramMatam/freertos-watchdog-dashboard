# 0 "/home/shivani/bl602_iot_sdk/components/freertos/misaligned/misaligned_ldst.c"
# 1 "/home/shivani/bl602_iot_sdk/customer_app/suas_app_freertos_watchdog/build_out/freertos//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/shivani/bl602_iot_sdk/components/freertos/misaligned/misaligned_ldst.c"


# 1 "/home/shivani/bl602_iot_sdk/components/freertos/misaligned/emulation.h" 1





# 1 "/home/shivani/bl602_iot_sdk/components/freertos/misaligned/encoding.h" 1
# 7 "/home/shivani/bl602_iot_sdk/components/freertos/misaligned/emulation.h" 2
# 1 "/home/shivani/bl602_iot_sdk/components/freertos/misaligned/bits.h" 1
# 8 "/home/shivani/bl602_iot_sdk/components/freertos/misaligned/emulation.h" 2
...
# 9 "/home/shivani/bl602_iot_sdk/components/freertos/misaligned/emulation.h" 2


# 10 "/home/shivani/bl602_iot_sdk/components/freertos/misaligned/emulation.h"
...
# 4 "/home/shivani/bl602_iot_sdk/components/freertos/misaligned/misaligned_ldst.c" 2
# 1 "/home/shivani/bl602_iot_sdk/components/freertos/misaligned/fp_emulation.h" 1
# 5 "/home/shivani/bl602_iot_sdk/components/freertos/misaligned/misaligned_ldst.c" 2
# 1 "/home/shivani/bl602_iot_sdk/components/freertos/misaligned/unprivileged_memory.h" 1
...
# 1 "/home/shivani/bl602_iot_sdk/components/freertos/misaligned/encoding.h" 1
# 7 "/home/shivani/bl602_iot_sdk/components/freertos/misaligned/unprivileged_memory.h" 2
# 39 "/home/shivani/bl602_iot_sdk/components/freertos/misaligned/unprivileged_memory.h"
...
# 6 "/home/shivani/bl602_iot_sdk/components/freertos/misaligned/misaligned_ldst.c" 2
# 17 "/home/shivani/bl602_iot_sdk/components/freertos/misaligned/misaligned_ldst.c"
union byte_array {
  uint8_t bytes[8];
  uintptr_t intx;
  uint64_t int64;
...
void misaligned_load_trap(uintptr_t* regs, uintptr_t mcause, uintptr_t mepc)
{
  ...
  uintptr_t addr = ({ unsigned long __tmp; asm volatile ("csrr %0, " "mtval" : "=r"(__tmp)); __tmp; });

  int shift = 0, fp = 0, len;
  if ((insn & 0x707f) == 0x2003)
    len = 4, shift = 8*(sizeof(uintptr_t) - len);
# 56 "/home/shivani/bl602_iot_sdk/components/freertos/misaligned/misaligned_ldst.c"
    ...
    len = 4, shift = 8*(sizeof(uintptr_t) - len);
# 82 "/home/shivani/bl602_iot_sdk/components/freertos/misaligned/misaligned_ldst.c"
...
void misaligned_store_trap(uintptr_t* regs, uintptr_t mcause, uintptr_t mepc)
{
  ...
  if ((insn & 0x707f) == 0x2023)
    len = 4;
# 134 "/home/shivani/bl602_iot_sdk/components/freertos/misaligned/misaligned_ldst.c"
...
# 158 "/home/shivani/bl602_iot_sdk/components/freertos/misaligned/misaligned_ldst.c"
